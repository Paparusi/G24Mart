...
import { Scan, Camera, Keyboard, Package, Zap } from 'lucide-react';
...
export default function POSBarcodeInput({ onProductScanned, products }: BarcodeInputProps) {
  ...
  const processBarcode = (barcode: string) => {
    ...
    // Find product in provided products list or demo products
    const allProducts = [...products, ...DEMO_PRODUCTS];
    const product = allProducts.find(p => p.barcode === trimmedBarcode);
      ...
      <div className="mt-4 pt-4 border-t">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-gray-600">Quét nhanh và chính xác</span>
          </div>
          <a
